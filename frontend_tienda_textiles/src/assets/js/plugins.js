...
;(function (v, p) {
  ...
  function C(a, b) {
    if (b in a.style)
      return (
        getComputedStyle(a).getPropertyValue(b.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase()) ||
        '0'
      )
  }
  function I(a, b) {
...
!(function () {
  ...
  class o {
    constructor(e, t) {
      ;((this.settings = t),
        ...
        NodeList.prototype.isPrototypeOf(e) || HTMLCollection.prototype.isPrototypeOf(e)
          ...
          : (this.images = e),
        this.settings.container instanceof Element || this.settings.container instanceof HTMLElement
    ...
    off(e, t) {
      ...
      this.events[s] &&
        (e.removeEventListener(t.split('.')[0], this.events[s].cb), this.events.splice(s, 1))
    }
  }
  const c = []
