...
!(function (a, b) {
  ...
  ;((n.fn = n.prototype =
    ...
    n.extend({
      ...
      makeArray: function (a, b) {
        var c = b || []
        return (
          null != a && (s(Object(a)) ? n.merge(c, 'string' == typeof a ? [a] : a) : f.call(c, a)),
          c
        )
      },
  ...
  var t = (function (a) {
    ...
    function ib(a, b) {
      var c = b && a,
        d =
          c && 1 === a.nodeType && 1 === b.nodeType && (~b.sourceIndex || B) - (~a.sourceIndex || B)
      if (d) return d
      ...
      if (j)
        for (b = (a || '').match(F) || []; i > h; h++)
          if (
            ((c = this[h]),
            (d =
              1 === c.nodeType && (c.className ? (' ' + c.className + ' ').replace(vc, ' ') : ' ')))
          ) {
            f = 0
